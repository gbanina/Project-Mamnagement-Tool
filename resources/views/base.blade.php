        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="alert alert-danger fade in" role="alert">
                    You have currently assimilated role of <strong>{{Auth::user()->userAccount()->role()->first()->name}}</strong>. Click  <a href="{{ TMBS::url('morph-return') }}" class="btn btn-round btn-default btn-xs">here</a>to return to your original role.
                </div>
            </div>
            @endif
            @yield('content')
