                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="{{ URL::to('admin/project-type/'.$type->id.'/edit') }}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                              <a href="{{ URL::to('admin/project-type/'.$type->id.'/edit') }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                              {{ Form::open(['route' => ['project-type.destroy', $type->id], 'method' => 'delete', 'style'=>'display: inline']) }}
